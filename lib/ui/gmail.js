...
function Gmail() {
  ...
  // this.hangouts = jQuery('.nH.aJl.nn');
  // this.hangoutsCss = '<style> .o8qlBb.PJ .gGnOIc.x2.qp.DI.QmCEdd { display: none; } </style>';
}
...
Gmail.prototype.applyHangoutsCss = function() {
  // this.hangouts.find('iframe').contents().find('head').append(this.hangoutsCss);
};
